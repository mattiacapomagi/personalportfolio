...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/" | "/about" | "/bento" | "/projects" | "/projects/[slug]" | "/tools" | "/tools/[slug]";
		RouteParams(): {
