...
function _page($$renderer, $$props) {
  ...
  if (project.gumroadLink) {
    $$renderer.push("<!--[-->");
    $$renderer.push(`<a${attr("href", project.gumroadLink)} target="_blank" rel="noopener noreferrer" class="gumroad-button svelte-gygcht">${escape_html(store_get($$store_subs ??= {}, "$language", language) === "en" ? "Buy Typeface" : "Acquista Font")}</a>`);
  } else {
    $$renderer.push("<!--[!-->");
  }
