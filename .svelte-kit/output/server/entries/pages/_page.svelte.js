import { w as attr, y as stringify, z as ensure_array_like, x as attr_class } from "../../chunks/index2.js";
...
function ProjectRow($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    function getCategoryTags(project2) {
      const rawCat = project2.category;
      return rawCat.split(/\/|\+/).map((c) => getAbbreviation(c.trim())).filter(Boolean);
    }
    $$renderer2.push(`<a${attr("href", `${stringify(base)}/projects/${stringify(project.slug)}`)} class="project-row svelte-1ftngtl"><div class="text-content svelte-1ftngtl"><span class="col title svelte-1ftngtl">${escape_html(project.title)}</span> <span class="col client svelte-1ftngtl">${escape_html(project.client)}</span> <span class="col category svelte-1ftngtl"><div class="tags svelte-1ftngtl"><!--[-->`);
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<!--]--></div> <div class="project-list-header svelte-1uha8ag"><span class="col svelte-1uha8ag">${escape_html("project title")}</span> <span class="col svelte-1uha8ag">${escape_html("client")}</span> <span class="col svelte-1uha8ag">${escape_html("category")}</span> <span class="col year svelte-1uha8ag">${escape_html("year")}</span></div> <div class="project-list svelte-1uha8ag"><!--[-->`);
